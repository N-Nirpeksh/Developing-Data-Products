...
#countryColors <- read.delim(file = colorsURL, as.is = 3) 

countryColors <- read.csv("CountryColors.csv", header=TRUE, as.is = 3)
...
GitHub</br>
[My GitHub](https://github.com/N-Nirpeksh/Developing-Data-Products/)
